...
SimpleForm.setup do |config|
  ...
  config.wrappers :horizontal_file_input, tag: 'div', class: 'form-group row', error_class: 'has-invalid' do |b|
    b.use :html5
    b.use :placeholder
    b.optional :maxlength
    b.optional :minlength
  ...
  config.wrappers :horizontal_boolean, tag: 'div', class: 'form-group row', error_class: 'has-invalid' do |b|
    b.use :html5
    b.optional :readonly
    b.use :label, class: 'col-lg-3 col-form-label'

    b.wrapper tag: 'div', class: 'offset-lg-3 col-lg-9' do |wr|
  ...
  config.wrappers :horizontal_radio_and_checkboxes, tag: 'div', class: 'form-group row', error_class: 'has-invalid' do |b|
    b.use :html5
    b.optional :readonly
  ...
  config.wrappers :inline_form, tag: 'div', class: 'form-group row', error_class: 'has-invalid' do |b|
    b.use :html5
    b.use :placeholder
    b.optional :maxlength
    b.optional :minlength
